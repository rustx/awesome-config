...
local function factory(args)
    local alsabar = { _current_level = 0, _playback      = "off", widget = wibox.widget.progressbar(), }
    ...
    alsabar.tooltip = awful.tooltip({ objects = { alsabar.widget } })
    ...
    function alsabar.update(callback)
        helpers.async(format_cmd, function(mixer)
            ...
            if vol ~= alsabar._current_level or playback ~= alsabar._playback then
                ...
                alsabar.widget:set_value(alsabar._current_level / 100)
